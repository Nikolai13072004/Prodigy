    ...
    <form action={action} onSubmit={validateForm} className="space-y-6">
      ...
      <section className="space-y-2">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <label className="text-sm font-semibold text-[var(--ink)]">Вопрос</label>
          <div className="flex flex-wrap items-center gap-2 text-xs text-[var(--ink-muted)]">
            ...
            <label className="inline-flex items-center gap-2 rounded-full border border-[var(--line)] bg-[var(--surface)] px-3 py-1.5">
              <span>Баллы</span>
              <input
                name="points"
                type="number"
                ...
                className="w-12 border-0 bg-transparent p-0 text-center text-xs font-semibold text-[var(--ink)] outline-none"
              />
            </label>
          </div>
        </div>
        <textarea
          ...
          className="w-full resize-y rounded-md border border-[var(--line)] bg-white px-3 py-3 text-sm shadow-inner outline-none transition focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--accent-soft)]"
        />
        {media ? (
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-2 text-sm">
              <button
                ...
                disabled={mediaBusy}
                className="inline-flex items-center gap-2 rounded-md border border-[var(--line)] px-3 py-2 text-[var(--ink)] hover:bg-[var(--accent-soft)] disabled:cursor-not-allowed disabled:opacity-50"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 rounded-md border border-[var(--danger)] px-3 py-2 text-[var(--danger)] hover:bg-[var(--danger-soft)]"
              >
          ...
          <button
            ...
            onClick={() => mediaInputRef.current?.click()}
            disabled={mediaBusy}
            className="inline-flex items-center gap-2 rounded-md border border-dashed border-[var(--line)] px-3 py-2 text-sm text-[var(--ink-muted)] transition hover:border-[var(--line)] hover:bg-[var(--accent-soft)] hover:text-[var(--ink)] disabled:cursor-not-allowed disabled:opacity-50"
          >
            <ImagePlus className="h-4 w-4" aria-hidden="true" />
        ...
        />
        {mediaError ? (
          <p className="text-sm text-[var(--danger)]">{mediaError}</p>
        ) : null}
      </section>
        ...
        <section className="space-y-3">
          ...
          <div className="overflow-hidden border-y border-[var(--line)]">
            {singleOptions.map((option, index) => (
              <div
                key={`option-${index}`}
                className="group grid grid-cols-[22px_28px_minmax(0,1fr)_auto] items-center gap-2 border-b border-[var(--line)] py-2 last:border-b-0"
              >
                <GripVertical className="h-4 w-4 text-[var(--ink-muted)]" aria-hidden="true" />
                <input
                  type="radio"
                  name="single-correct"
                ...
                <input
                  ...
                  className="h-10 w-full border-0 bg-transparent px-1 text-sm outline-none placeholder:text-[var(--ink-muted)] focus:ring-0"
                />
                <div className="flex items-center gap-1 opacity-100 transition sm:opacity-0 sm:group-focus-within:opacity-100 sm:group-hover:opacity-100">
                  <button
                    ...
                    className="rounded-md p-1.5 text-[var(--ink-muted)] hover:bg-[var(--accent-soft)] disabled:cursor-not-allowed disabled:opacity-30"
                  ...
                  <button
                    ...
                    className="rounded-md p-1.5 text-[var(--danger)] hover:bg-[var(--danger-soft)] disabled:cursor-not-allowed disabled:opacity-30"
            ...
            <button
              ...
              className="flex w-full items-center gap-2 px-12 py-3 text-left text-sm text-[var(--ink-muted)] transition hover:bg-[var(--accent-soft)] hover:text-[var(--ink)]"
            >
            ...
            <div>
              <div className="mb-2 flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={addLeft}
                  className="inline-flex items-center gap-1 rounded-md border border-[var(--line)] px-2 py-1 text-xs hover:bg-[var(--accent-soft)]"
                >
                ...
                {matchingLeft.map((value, index) => (
                  <div key={`left-${index}`} className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="rounded-md p-2 text-[var(--danger)] hover:bg-[var(--danger-soft)] disabled:opacity-40"
      ...
      <div className="flex flex-wrap gap-2">
        ...
        {cancelHref ? (
          <Link
            href={cancelHref}
            className="rounded-md border border-[var(--line)] px-4 py-2.5 text-sm hover:bg-[var(--accent-soft)]"
          >
            Отмена
          </Link>
        ) : null}
